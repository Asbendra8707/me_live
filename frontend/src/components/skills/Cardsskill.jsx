  ...
  return (
    <>
      <div className='container rounded-4 p-3 my-5' style={{ backgroundColor: '#14471a' }}>
        <h1 className='text-center text-white '>I SPECIALIZE IN A</h1>
        <h1 className='text-center'>RANGE OF 💪SKILLS</h1>
      ...
      <div>
        <Container className='my-5'>
          ...
          <Row>
            <Col>
              <h5 className='stexth5 text-white'> HTML <h6 className='d-flex'> 95%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={95} label={`${95}%`} /></h6>
              </h5>
              <h5 className='stexth5 text-white'>CSS <h6 className='d-flex'> 90%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={90} label={`${90}%`} /></h6>
              </h5>
              <h5 className='stexth5 text-white'> JAVASCRIPT <h6 className='d-flex'> 60%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={60} label={`${60}%`} /></h6>
              </h5>
              <h5 className='stexth5 text-white'> REACT JS <h6 className='d-flex'> 85%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={85} label={`${85}%`} /></h6>
              </h5>
              <h5 className='stexth5 text-white'> MONGODB <h6 className='d-flex'> 60%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={60} label={`${60}%`} /></h6>
              </h5>
            </Col>
            <Col xs={6} md={6} className=''>
              <h5 className='stexth5 text-white'> EXPRESS <h6 className='d-flex'> 60%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={60} label={`${60}%`} /></h6>
              </h5>           
              <h5 className='stexth5 text-white'> NODE JS <h6 className='d-flex'> 75%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={75} label={`${75}%`} /></h6>
              </h5>           
              <h5 className='stexth5 text-white'> REDUX <h6 className='d-flex'> 55%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={55} label={`${55}%`} /></h6>
              </h5>           
              <h5 className='stexth5 text-white'>GIT & GITHUB <h6 className='d-flex'> 85%
                <ProgressBar className='mx-2 w-75' variant='success' animated now={85} label={`${85}%`} /></h6>
              </h5>
            </Col>
          </Row>
